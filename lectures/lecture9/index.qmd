...
|     Examples    |     PROMOD,   GE-Maps, PLEXOS, GridView    |     Positive sequence load flow (PSLF),   power system simulator for engineering (PSSE)    |     NEMS, ReEDS,   Integrated Planning Model, MARKAL,   Haiku    |
...
- Tome horizon: near (2025), medium(2030), long (2050)\
