...
1. Learn to use [PVWatts](https://pvwatts.nrel.gov/index.php) to simulate the monthly and annual generation of a distributed PV system. Please use the below sysetm information:
Location: 11794  
...
Household monthly PV system connection fee: $15  
